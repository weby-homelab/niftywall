...
## ✨ Що нового у версії 1.4.0 (Time Machine)

- **🕰️ Машина часу (Auto-Snapshots):** Відчуйте себе в безпеці! Перед кожною зміною фаєрвола (наприклад, додаванням порту або видаленням правила), NiftyWall автоматично робить знімок поточної конфігурації. На новій вкладці "Time Machine" ви можете відкотитися до попереднього стану в один клік, якщо щось пішло не так.
