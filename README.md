...
- **🛡️ SAFE Mode (Екстрене блокування):** Ваш цифровий "стоп-кран" для сервера. Кнопка **SAFE Mode** активує режим екстреного захисту:
    ...
    3.  **Білий список**: Застосовується мінімальна конфігурація, що дозволяє трафік лише для критичних сервісів: SSH (22, 54322), NiftyWall (8080) та довірених інтерфейсів (Tailscale, Loopback).
